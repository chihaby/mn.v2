        ...
        <Row>
          <Col xs={12} md={3}>
            <Link href='/' passHref style={{ color: 'inherit', textDecoration: 'inherit'}} >
              <span style={{fontSize: '24px', fontWeight: '600'}}>Mediterranean Nights</span>
            </Link>
            <hr />
            <Subscribe />
          </Col>
          ...
          <Col xs={6} md={3}>
            ...
            <ul >         
              <li className={styles.li}>
                <Link href='/store' passHref><span className={styles.site_map}>Store</span></Link>
              </li>   
              {/* <li className={styles.li}>
